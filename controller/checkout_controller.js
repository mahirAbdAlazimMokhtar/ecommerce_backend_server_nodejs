...
const { Cart } = require("../models/cart_products");
const { Product } = require("../models/product");
const orderController = require("../controller/orders_controller");
const emailSender = require("../helpers/email_senders");
const emailBuilder = require("../helpers/order_complete_email_builder");
...
exports.checkoutWebhook = async (req, res) => {
  ...
  if (event.type === "checkout.session.complete") {
    ...
    stripe.customers
      ...
      .catch((error) => console.error("WEBHOOK ERROR CATCHER:",
         err.message));
  } else {
